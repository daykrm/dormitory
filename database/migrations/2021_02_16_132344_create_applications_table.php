...
class CreateApplicationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('applications', function (Blueprint $table) {
            ...
            $table->string('address_fa',100)->nullable();
            $table->integer('sub_district_id_fa')->nullable();
            $table->string('phone_fa',10)->nullable();
            ...
            $table->string('address_mo',100)->nullable();
            $table->integer('sub_district_id_mo')->nullable();
            $table->string('phone_mo',10)->nullable();
            ...
            $table->string('address_sp',100)->nullable();
            $table->integer('sub_district_id_sp')->nullable();
            $table->string('phone_sp',10)->nullable();
            ...
            $table->string('vehicle_year', 100)->nullable();
            $table->string('vehicle_month', 100)->nullable();
